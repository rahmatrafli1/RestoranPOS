...
const POSPage = () => {
    ...
    // Safe access to cart state with default values
    ...
    return (
        <div className="h-[calc(100vh-8rem)] flex gap-6">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="mb-4">
                    <OrderTypeSelector
                        selectedType={cart.orderType || "dine_in"}
                        onTypeChange={handleOrderTypeChange}
                        tableName={
                            cart.table_id
                                ? `Table ${tables.find((t) => t.id === cart.table_id)?.table_number}`
                                : null
                        }
                    />
                </div>
